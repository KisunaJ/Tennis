...
public class EntrenadorController {
    ...
    @PostMapping
    public ResponseEntity<EntrenadorDTO> save(@RequestBody EntrenadorDTO entrenador) {

        return ResponseEntity.ok(entrenadorService.save(entrenador));
    }

    @PutMapping("/{id}")
    public ResponseEntity<EntrenadorDTO> update(@PathVariable long id, @RequestBody EntrenadorDTO entrenador) {

        entrenador.setId(id);
        return ResponseEntity.ok(entrenadorService.update(entrenador));
    }
    @DeleteMapping("/{id}")
